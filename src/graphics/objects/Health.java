...
public class Health extends Sprite {
  ...
  private static Animation[] loadAnimations() {
    ...
    anims[0].addFrame(IOUtils.loadImage("res/images/tilesets/temp/health1.png"), 200);
    anims[0].addFrame(IOUtils.loadImage("res/images/tilesets/temp/health2.png"), 200);
